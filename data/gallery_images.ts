...
const TROPHIES: Trophies[] = [
    ...
    { url: "/trophies/TestMace.jpeg", title: "ICC Test Mace", details: [" the ICC Test Mace was given to the team that stayed No. 1 in Test cricket. Under Virat Kohli's captaincy, India ruled the format, winning the mace five years in a row from 2016 to 2020 — a golden era for Indian Test cricket."] },
    { url: "/trophies/U19WC.jpeg", title: "U19 World Cup", details: ["U19 World Cup 2008, Under the Captaincy of Virat Kohli, India won the final against Australia. just a beginning of a legendary career."] },
];
